...
This program is not internet dependent and only uses libraries contained in version 9 of Oracle's Java Development Kit.
...
2. embed JDK 9 into this executable installer file.
