 ...
 */
public abstract class MastermindKeyboardInterface {
    /**
    ...
    //protected final MasterminduState mastermindState;
     ...
     */
    protected MastermindKeyboardInterface(
    ...
    protected boolean selectedPointInBounds(@NotNull Point pointToSet) {
        ...
        return true;//pointToSet.x >= 0 && pointToSet.y >= 0 && pointToSet.x < boardSize && pointToSet.y < boardSize;
    }
}
